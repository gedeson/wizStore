...
{{ Form::open(array('url' => 'product/new', 'class' => 'form-horizontal', 'role' => 'form','enctype'=>"multipart/form-data")) }}
...
<div class="form-group">
    <label for="titulo" class="col-lg-2 control-label">Tamanho</label>
    <div class="col-lg-6">
        {{ Form::select('size', Config::get('constants.SIZE'), $product->size, array('class' => 'form-control')) }}
    </div>
</div>


<div class="form-group">
    <label for="titulo" class="col-lg-2 control-label">Cor</label>
    <div class="col-lg-6">
        {{ Form::select('color', Config::get('constants.COLOR'), $product->color, array('class' => 'form-control')) }}
    </div>
</div>
...
<div class="form-group">
    <div class="col-lg-offset-2 col-lg-10 right-align">
        <button type="submit"  class="btn-floating btn-large blue tooltipped"><i class="material-icons">check</i></button>
